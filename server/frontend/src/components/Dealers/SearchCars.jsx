...
{/* Declare a functional component named SearchCars */}
const SearchCars = () => {
  ...
  {/* Extract the 'id' parameter from the URL and construct URLs for API calls */}
  const { id } = useParams();
  let dealer_url = `/djangoapp/get_inventory/${id}`;
  let fetch_url = `/djangoapp/dealer/${id}`;
  
  {/* async function to fetch dealer*/}
  ...
  {/*function to take an array of cars and populate the makes and models*/}
...
{/* async function to fetch car*/}
  ...
  {/*Function to manage state of 'make' */}
  let SearchCarsByMake = async ()=> {
   ...
   {/*Function to manage state of 'model' */}
   ...
   {/*Function to manage state of 'year' */}
  ...
  {/*Function to manage state of 'mileage' */}
  ...
  {/*Function to manage state of 'price' */}
  ...
  {/*Func to reset all dropdowns to their defaults  */}
  const reset = ()=>{
  ...
  {/*useEffect hook to call the fetchCars and fetchDealer functions to initialize*/}
  useEffect(() => {
    fetchCars();
    fetchDealer();
  },[]); 
